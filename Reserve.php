 ...
 <nav  class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-end pl-1">
    ...
    <div class="collapse navbar-collapse flex-grow-0" id="navbarSupportedContent">
         ...
         <ul class="navbar-nav text-right">
            ...
            <li class="nav-item">
                 <i class="fas fa-user-shield" style="color: white;"></i>&nbsp;&nbsp;<a class="navbar-text" style="color: white;" >Ms./Mr. <?php echo $_SESSION['NameF'] ?> <?php echo $_SESSION['Name'] ?></a>
            </li>
        </ul>
    </div>
            ...
            if ($row['Status'] !="Using"){
                ...
                var x = setInterval(function() {
                  ...
                  if (distance < 0) {
                    ...
                    $.post("Cancel_email.php",{data:jdata},function(result){
                      alert("Your Last Reservation has been Expired ! ");
                      },"json");
